...
function App() {
  ...
  return (
    ...
    >
      ...
      <Grid style={{ marginBottom: 15 }} sx={{ width: "75%" }}>
        <p
          style={{
            display: "table-cell",
            verticalAlign: "middle",
        ...
        >
          ...
          โดยสามารถป้อนข้อความภาษาไทยในการทดสอบ
          ทั้งนี้ขอความอนุเคราะห์ให้ข้อมูลการวิเคราะห์ว่าถูกต้องหรือไม่
          โดยกดยืนยันความถูกต้องในการวิเคราะห์ของแอปพลิเคชันนี้
          ขอขอบพระคุณอย่างสูงในการให้ข้อมูล
        </p>
      </Grid>
      ...
      <Card
        sx={{ maxWidth: 500, m: 3.5, minWidth: 300 }}
